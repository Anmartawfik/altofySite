...
<div id="fixedBox" class=" ">
  ...
  <div id="fixedToggle"> <span class="fa fa-plus"></span> </div>
        ...
        <div id="box-container" class="box-container box-effect-1">
  <div id="header_slide" class="active"><span></span></div>
        <div class="hidden-xs left-menu" id="header7">
    <div class="shade"></div>
    <div class="header_box">
      <div class="header_box2">
        ...
        <nav>
          <div id="hover_menu" class="IHide-sm IHide-md">
  ...
  <div class="rightmain"> 
      ...
      <div id="dnn_wrapper">
            <header class="header_bg roll_menu    ">                                                             <div class="visible-xs mobile_header">
