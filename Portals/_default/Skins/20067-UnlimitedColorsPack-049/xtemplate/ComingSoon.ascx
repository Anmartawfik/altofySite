...
#if(${xf.ViewXmlSetting("Showshade","Show")} == "Show")
<div class="shade"></div>
#end
#if(${xf.ViewXmlSetting("Backgroundcolorsytle","Default Image")} == "Default Image")
<div id="parent"> </div>
#end

#if(${xf.ViewXmlSetting("Backgroundcolorsytle","Default Image")} == "Page Background")
...
$(document).ready(function(){
			$("#countdown").countdown({
				date: "${xf.ViewXmlSetting("endtime","12 September 2016 11:49:00")}",
				format: "on",
				time_end:"off"
			},
			function() {
